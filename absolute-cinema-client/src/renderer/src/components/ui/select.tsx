...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "bg-black text-white border border-white/15 rounded-xl px-4 py-2 shadow focus:border-white/30 focus:ring-2 placeholder:text-white/40 transition-all duration-200 flex w-fit items-center justify-between gap-2 whitespace-nowrap ring-1 ring-white/10 focus:ring-white/30",
        className
      )}
      {...props}
    >
